                        ...
                        <div className="col-lg-6" style={{background:'var(--color-white)'}}>
                            <div className="content d-flex flex-column justify-content-center h-100">
                                ...
                                <ul>
                                    ...
                                    <li><Link aria-current="page" to="https://iitj.ac.in/uploaded_docs/dept_upload/cml/PhD_Adv_Jan2024_image-2023-10-10-10-33-am.jpg" style={{color:'var(--color-secondary)'}} target="_blank" rel="noopener noreferrer"><i className="bi bi-check-circle-fill"></i>news letter { showImage && <img src='https://nta.ac.in/img/newicon.gif'></img>} </Link></li>
                                        <li><Link aria-current="page" to="" style={{color:'var(--color-secondary)'}} target="_blank" rel="noopener noreferrer"><i className="bi bi-check-circle-fill"></i>Congratulations </Link>
                                    </li>
